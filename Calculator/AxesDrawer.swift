...
struct AxesDrawer
{
    ...
    fileprivate let formatter = NumberFormatter() // formatter for the hashmark labels
    
    fileprivate func drawHashmarks(in rect: CGRect, origin: CGPoint, pointsPerUnit: CGFloat)
    {
    ...
    fileprivate func drawHashmark(at location: CGPoint, label: AnchoredText)
    {
